...
class TestMaksukortti(unittest.TestCase):
    def setUp(self):
        #alustetaan maksukortti, jossa on 10€ saldoa (1000 senttiä)
    ...
    def test_kortilla_voi_ostaa_edullisen_lounaan_250_sentin_saldolla(self):
        kortti = Maksukortti(250)
        kortti.syo_edullisesti()

        self.assertEqual(str(kortti), "Kortilla on rahaa 0.00 euroa")

    def test_kortilla_voi_ostaa_maukkaan_lounaan_400_sentin_saldolla(self):
